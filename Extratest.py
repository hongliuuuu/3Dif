...
def mcode(ite):
    ...
    if ite ==0:
        ...
        Xnew4 = X[:, 5040:6720]
        Xnew5 = X[:, 6720:6745]
    testfile = open(("Extra"+ss+"%f_%f.txt" % (R, ite)), 'w')
    erfsvm = []
    for ii in range(10):
        ...
        X_features_train1, X_features_test1, w1, pred1 = Extreme_rf_dis(n_trees=500, X=Xnew1, Y=Y, train_indices=train_indices,
        ...
        X_features_train2, X_features_test2, w2, pred2 = Extreme_rf_dis(n_trees=500, X=Xnew2, Y=Y, train_indices=train_indices,
                                                                test_indices=test_indices, seed=seed)
        ...
        X_features_train3, X_features_test3, w3, pred3 = Extreme_rf_dis(n_trees=500, X=Xnew3, Y=Y, train_indices=train_indices,
                                                                test_indices=test_indices, seed=seed)
        ...
        X_features_train4, X_features_test4, w4, pred4 = Extreme_rf_dis(n_trees=500, X=Xnew4, Y=Y, train_indices=train_indices,
                                                                test_indices=test_indices, seed=seed)
        ...
        X_features_train5, X_features_test5, w5, pred5 = Extreme_rf_dis(n_trees=500, X=Xnew5, Y=Y, train_indices=train_indices,
                                                                test_indices=test_indices, seed=seed)
